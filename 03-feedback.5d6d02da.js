...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r="feedback-form",a=document.querySelector("form"),l=document.querySelector("input"),o=document.querySelector("textArea");let u={email:"",message:""};function n(){let e=localStorage.getItem(r);e&&(e=JSON.parse(e),Object.entries(e).forEach(([e,t])=>{u[e]=t,a.elements[e].value=t}))}n();const s=e=>{u[e.target.name]=e.target.value,localStorage.setItem(r,JSON.stringify(u))},c=e=>{e.preventDefault();const t={email:l.value,message:o.value};console.log(t),l.value="",o.value="",u={},localStorage.removeItem(r),e.currentTarget.reset()};a.addEventListener("input",(0,e.default)(s,500)),a.addEventListener("submit",c);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.5d6d02da.js.map